...
func (client *Client) BlockHeader(ctx context.Context, r *BlockRequest) (*BlockHeaderInfo, error) {
	...
	if err := client.request(ctx, "GET", path.String(), params, nil, response, proto); err != nil {
		return nil, err
	}
	return response, nil
}
...
func (client *Client) BlockShellHeader(ctx context.Context, r *BlockRequest) (*BlockShellHeader, error) {
	...
	if err := client.request(ctx, "GET", path.String(), nil, nil, response, nil); err != nil {
		return nil, err
	}
	return response, nil
}
...
func (client *Client) RunOperation(ctx context.Context, r *RunOperationRequest) (*OperationWithOptionalMetadata, error) {
	...
	if err := client.request(ctx, "POST", path.String(), nil, payload, response, nil); err != nil {
		return nil, err
	}
	return response, nil
}
...
func (client *Client) InjectOperation(ctx context.Context, r *InjectOperationRequest) (*OperationHash, error) {
	...
	if err := client.request(ctx, "POST", path.String(), params, payload, response, nil); err != nil {
		return nil, err
	}
	return response, nil
}
