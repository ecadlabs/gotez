...
var path_BlockHash = template.Must(template.New("path").Parse("/chains/{{.Chain}}/blocks/{{.Block}}/hash"))

func (client *Client) BlockHash(ctx context.Context, r *SimpleRequest) (*BlockHash, error) {
	var path strings.Builder
	if err := path_BlockHash.Execute(&path, r); err != nil {
		return nil, err
	}
	response := new(BlockHash)
