...
type TicketReceipt = proto_021_PsQuebec.TicketReceipt
type EpDefault = proto_021_PsQuebec.EpDefault
type EpRoot = proto_021_PsQuebec.EpRoot
type EpDo = proto_021_PsQuebec.EpDo
type EpSetDelegate = proto_021_PsQuebec.EpSetDelegate
type EpRemoveDelegate = proto_021_PsQuebec.EpRemoveDelegate
type EpDeposit = proto_021_PsQuebec.EpDeposit
type EpNamed = proto_021_PsQuebec.EpNamed
type EpStake = proto_021_PsQuebec.EpStake
type EpUnstake = proto_021_PsQuebec.EpUnstake
type EpFinalizeUnstake = proto_021_PsQuebec.EpFinalizeUnstake
type EpSetDelegateParameters = proto_021_PsQuebec.EpSetDelegateParameters
type PseudoOperation = proto_021_PsQuebec.PseudoOperation
type Transaction = proto_021_PsQuebec.Transaction
type Parameters = proto_021_PsQuebec.Parameters
type ToSmartRollup = proto_021_PsQuebec.ToSmartRollup
...
var ListPseudoOperations = proto_021_PsQuebec.ListPseudoOperations
