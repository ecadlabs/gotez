...
func TestDecodeOperations(t *testing.T) {
	...
	testCases := []testCase{
		...
		{
			title: "double_emmy_endorsement_evidence",
		...
		},
		{
			...
			expect: &Origination{
				...
				Delegate: tz.None[PublicKeyHash](),
				Code: []byte{
