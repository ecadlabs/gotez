...
func (self *TransferTicketSuccessfulManagerResult) MarshalJSON() ([]byte, error) {
	type TransferTicketSuccessfulManagerResult_no_json_marshaller TransferTicketSuccessfulManagerResult

	type json_TransferTicketSuccessfulManagerResult struct {
		Marker0 any `json:"kind"`
		*TransferTicketSuccessfulManagerResult_no_json_marshaller
	}

	tmp := json_TransferTicketSuccessfulManagerResult {
		Marker0: self.OperationKind(),
		TransferTicketSuccessfulManagerResult_no_json_marshaller: (*TransferTicketSuccessfulManagerResult_no_json_marshaller)(self),
	}
